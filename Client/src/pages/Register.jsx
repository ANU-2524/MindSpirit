    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width="48" height="48" fill="none" viewBox="0 0 24 24"><path fill="#fff" d="M12 2a7 7 0 0 1 7 7c0 3.87-3.13 7-7 7s-7-3.13-7-7a7 7 0 0 1 7-7Zm0 16c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4Z"/></svg>
        </div>
        <h2 style={{
          textAlign: 'center',
          fontWeight: 800,
        ...
        <p style={{ textAlign: 'center', color: '#666', marginBottom: '1.5rem' }}>Join MindSpirit and boost your productivity!</p>
        ...
        <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
          <a href="/login" style={{ color: '#6a82fb', fontWeight: 600, textDecoration: 'underline', cursor: 'pointer' }}>Already have an account? Login</a>
        </div>
      </div>
    </div>
  );
